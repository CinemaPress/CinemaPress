module.exports = {
  ...
  "movies": {
    "cron": [
      ...
      "1 ~ https://api.tvmaze.com/schedule/web ~ 0._embedded.show.externals.imdb <> custom.imdb_id ~ https://api.themoviedb.org/3/find/[imdb_id]?language=ru&external_source=imdb_id&api_key=af6887753365e14160254ac7f4345dd2 ~ tv_results.0.name <> title_ru <> 1 ~ tv_results.0.original_name <> title_en <> 1 ~ tv_results.0.poster_path <> poster <> 1",
      "1 ~ https://api.tvmaze.com/schedule ~ 0._embedded.show.externals.imdb <> custom.imdb_id ~ https://api.themoviedb.org/3/find/[imdb_id]?language=ru&external_source=imdb_id&api_key=af6887753365e14160254ac7f4345dd2 ~ tv_results.0.name <> title_ru <> 1 ~ tv_results.0.original_name <> title_en <> 1 ~ tv_results.0.poster_path <> poster <> 1",
