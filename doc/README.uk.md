...
[https://cinemapress.sh/#uk](https://cinemapress.sh/#uk)

[![Встановіть через веб-сайт](https://raw.githubusercontent.com/CinemaPress/CinemaPress/master/themes/default/public/admin/images/min/web.png)](https://cinemapress.sh/#uk)
...
···· | **[ВИБРАТИ](https://cinemapress.io/ref/ua-hosting.html)** | **[ВИБРАТИ](https://cinemapress.io/ref/inferno.html)** | **[ВИБРАТИ](https://cinemapress.io/ref/myvps.html)** | **[ВИБРАТИ](https://cinemapress.io/ref/zomro.html)**
...
Докладну інформацію про всі параметри та модулі системи можна знайти в [документації](https://CInemaPress.io/admin).
