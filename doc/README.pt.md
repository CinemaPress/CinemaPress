...
> O sistema operacional deve ser o **CentOS 7/8, Debian 9/10, Ubuntu 18/20, Fedora 32/33** sem painéis de controle!
...
···· | **[SELECIONAR](https://cinemapress.io/ref/ua-hosting.html)** | **[SELECIONAR](https://cinemapress.io/ref/inferno.html)** | **[SELECIONAR](https://cinemapress.io/ref/pq.html)** | **[SELECIONAR](https://cinemapress.io/ref/zomro.html)**
...
Informações detalhadas sobre todas as opções e módulos do sistema podem ser encontradas na [documentação](https://CInemaPress.io/ru/admin).
