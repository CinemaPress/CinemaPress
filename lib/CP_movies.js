    ...
    function(task, task_index, callback) {
      ...
      async.forever(
        function(next) {
          ...
          console.log(task.page.replace('[page]', i));
          axios(task.page.replace('[page]', i))
            .then(function(r) {
              ...
              if (all && all.length) {
                ...
                console.error('STOP PAGE:', i);
                return next('STOP');
              }
            })
            .catch(function(err) {
              console.error('STOP PAGE:', i, err);
              return next('STOP');
            });
        },
        function() {
          async.eachOfLimit(
            ...
            function(id, id_index, callback) {
              ...
              axios((task.id + '').replace(/\[[a-z0-9_]+?]/i, id))
                .then(function(j) {
                  ...
                  task.info.forEach(function(info) {
                    ...
                    if (
                      ...
                      op.set(movie, parse[1], listItem.toString());
                    }
                  });
                  ...
                  CP_get.movies(
                    ...
                    function(err, rt) {
                      ...
                      if (rt && rt.length) {
                        ...
                        console.log('SAVE UPDATE MOVIE:', update_movie);
                ...
                .catch(function(err) {
                  console.error('STOP PAGE:', i, err);
                  console.log('ADDED:', added_m);
                  console.log('UPDATE:', update_m);
                  return callback();
                });
            },
            function() {
