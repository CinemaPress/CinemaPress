  ...
  return function(req, res, next) {
    ...
    if (
      ...
      if (
        ...
        ips = ips.filter(function(v, i, a) {
          return v && v !== '::ffff:127.0.0.1' && a.indexOf(v) === i;
        });
    ...
    if (
      ...
      whois.lookup(req.userinfo.ip, function(err, data) {
        if (err) {
          ...
          req.userinfo.whois = !!modules.abuse.data.whois.filter(function(w) {
