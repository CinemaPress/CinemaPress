...
module.exports = function(lookup) {
  ...
  return function(req, res, next) {
    ...
    var botMain = /(google|yandex|bing|yahoo|baidu|duckduckgo|mail.ru|facebook|vk|twitter|telegram|whatsapp)/i.test(
      ua
    );

    req.userinfo = {};
    req.userinfo.bot = {};
    req.userinfo.bot.all = isbot(ua);
    req.userinfo.bot.main = botMain;
    req.userinfo.ip = (
      (
