...
if (
  ...
  modules.content.data.parser &&
  modules.content.data.parser.length
) {
  active.num++;

  active.process.parser = true;
          ...
          Object.keys(ids)
            ...
            .forEach(function(id) {
              ...
              if (ids[id][0] && ids[id][0].translate) {
                m.translate = ids[id][0].translate;
              }
      ...
      CP_get.movies(
        ...
        function(err, ms) {
          ...
          if (ms && ms.length) {
            ...
            var content_movies = content.content_movies.split(',');
