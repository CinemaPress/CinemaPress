  ...
  async.eachOfLimit(
    ...
    function(task, index, callback) {
      ...
      if (
        parse &&
        parse[3] &&
        (parse[3] === 'douban' || parse[3] === 'douban_id')
      ) {
      ...
      if (
        ...
        (parse[3] === 'wa' ||
          parse[3] === 'wa_id' ||
          parse[3] === 'world-art' ||
          parse[3] === 'world-art_id' ||
          parse[3] === 'world_art' ||
          parse[3] === 'world_art_id')
      ) {
      ...
      if (
        parse &&
        parse[3] &&
        (parse[3] === 'tvmaze' || parse[3] === 'tvmaze_id')
      ) {
      ...
      request(
        ...
        function(error, response, body) {
          ...
          async.eachOfLimit(
            ...
            function() {
              if (!tvs || !tvs.length) {
                console.log('[CP_get.movies]', queries, 'NOT SERIES');
